...
_SOURCE_LABELS = {
    "apmatia_admin": "Apmatia administration",
...
_PROVIDER_GROUP_FALLBACKS: dict[str, tuple[str, str, str]] = {
    "builtin.apmatia_create_agent": ("module", "apmatia_admin", "Apmatia administration"),
    "builtin.apmatia_clone_agent_as": ("module", "apmatia_admin", "Apmatia administration"),
    "builtin.apmatia_set_agent_mode": ("module", "apmatia_admin", "Apmatia administration"),
    "builtin.apmatia_os_admin": ("module", "os_admin", "OS admin"),
    "builtin.ipe_what_do_i_do": ("library", "ipe", "Integrated productivity environment"),
    "builtin.memory_create": ("module", "memory_manager", "Memory Manager"),
    "builtin.memory_search": ("module", "memory_manager", "Memory Manager"),
    "builtin.memory_get": ("module", "memory_manager", "Memory Manager"),
    "builtin.memory_update": ("module", "memory_manager", "Memory Manager"),
    "builtin.memory_archive": ("module", "memory_manager", "Memory Manager"),
    ...
    "builtin.wiki_create_branch": ("module", "knowledge_wiki", "Knowledge Wiki"),
    "builtin.wiki_create_leaf": ("module", "knowledge_wiki", "Knowledge Wiki"),
    "builtin.wiki_update_node": ("module", "knowledge_wiki", "Knowledge Wiki"),
    "builtin.wiki_get_tree": ("module", "knowledge_wiki", "Knowledge Wiki"),
    "builtin.wiki_search": ("module", "knowledge_wiki", "Knowledge Wiki"),
    "builtin.wiki_move_node": ("module", "knowledge_wiki", "Knowledge Wiki"),
    "builtin.wiki_reorder_node": ("module", "knowledge_wiki", "Knowledge Wiki"),
