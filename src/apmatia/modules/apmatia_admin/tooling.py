...
def apmatia_admin_tool_definitions() -> list[dict[str, Any]]:
    return [
        {
...
class ApmatiaAdminToolProvider:
    provider_id: str
    action: str
...
def build_apmatia_admin_tool_providers(agent_service: AgentService) -> list[ToolProvider]:
    return [
