...
MODEL_VIEW_SPEC = AiModelCollectionViewSpec(
    action_id="apmatia_ai_model_manager.models",
    view_id="apmatia_ai_model_manager.models.view",
    ...
    list_command_id="apmatia_ai_model_manager.models.list",
    create_command_id="apmatia_ai_model_manager.models.create",
    edit_command_id="apmatia_ai_model_manager.models.edit",
    delete_command_id="apmatia_ai_model_manager.models.delete",
    scan_command_id="apmatia_ai_model_manager.models.scan",
    show_command_id="apmatia_ai_model_manager.models.show",
)


PREFERENCE_VIEW_SPEC = AiModelCollectionViewSpec(
    action_id="apmatia_ai_model_manager.preferences",
    view_id="apmatia_ai_model_manager.preferences.view",
    ...
    list_command_id="apmatia_ai_model_manager.preferences.list",
    create_command_id="apmatia_ai_model_manager.preferences.create",
    edit_command_id="apmatia_ai_model_manager.preferences.edit",
    delete_command_id="apmatia_ai_model_manager.preferences.delete",
)
