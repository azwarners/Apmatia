    ...
    descriptors.extend(
        (
            CommandContribution(
                ...
                command_id="apmatia_contacts_and_discussions.topics.assess_transition",
                path=("apmatia_contacts_and_discussions", "topics", "assess_transition"),
            ...
            CommandContribution(
                module_id="apmatia_contacts_and_discussions",
                action_id=topic_spec.action_id,
                command_id="apmatia_contacts_and_discussions.topics.summarize",
                path=("apmatia_contacts_and_discussions", "topics", "summarize"),
