...
TOPIC_VIEW_SPEC = TopicCollectionViewSpec(
    ...
    view_id="contacts_and_discussions.topics.view",
    object_type="topic",
    ...
    list_command_id="contacts_and_discussions.topics.list",
    create_command_id="contacts_and_discussions.topics.create",
    edit_command_id="contacts_and_discussions.topics.edit",
    delete_command_id="contacts_and_discussions.topics.delete",
    extra_command_ids=("contacts_and_discussions.topics.assess_transition", "contacts_and_discussions.topics.summarize"),
)

DISCUSSION_VIEW_SPEC = TopicCollectionViewSpec(
    action_id="contacts_and_discussions.discussions",
    view_id="contacts_and_discussions.discussions.view",
    ...
    list_command_id="contacts_and_discussions.discussions.list",
    create_command_id="contacts_and_discussions.discussions.create",
    edit_command_id="contacts_and_discussions.discussions.edit",
    delete_command_id="contacts_and_discussions.discussions.delete",
)

PARTICIPANT_VIEW_SPEC = TopicCollectionViewSpec(
    action_id="contacts_and_discussions.chat_targets",
    view_id="contacts_and_discussions.chat_targets.view",
    ...
    list_command_id="contacts_and_discussions.chat_targets.list",
    create_command_id="contacts_and_discussions.chat_targets.create",
    edit_command_id="contacts_and_discussions.chat_targets.edit",
    delete_command_id="contacts_and_discussions.chat_targets.delete",
)

SUMMARY_VIEW_SPEC = TopicCollectionViewSpec(
    action_id="contacts_and_discussions.summaries",
    view_id="contacts_and_discussions.summaries.view",
    object_type="summary",
    ...
    list_command_id="contacts_and_discussions.summaries.list",
    create_command_id="contacts_and_discussions.summaries.create",
    edit_command_id="contacts_and_discussions.summaries.edit",
    delete_command_id="contacts_and_discussions.summaries.delete",
)

TURN_VIEW_SPEC = TopicCollectionViewSpec(
    action_id="contacts_and_discussions.turns",
    view_id="contacts_and_discussions.turns.view",
    object_type="turn",
    ...
    list_command_id="contacts_and_discussions.turns.list",
    create_command_id="contacts_and_discussions.turns.create",
    edit_command_id="contacts_and_discussions.turns.edit",
    delete_command_id="contacts_and_discussions.turns.delete",
)
