...
APMATIA_DISCUSS_MODULE = ModuleMetadata(
    module_id="discuss",
    name="Discuss",
    version="0.1.0",
...
def register(registry: Registry) -> None:
    registry.register_module(APMATIA_DISCUSS_MODULE)
...
APMATIA_TOPIC_MANAGEMENT_MODULE = APMATIA_DISCUSS_MODULE
