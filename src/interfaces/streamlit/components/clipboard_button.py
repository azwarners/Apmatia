...
def render_clipboard_image_paste_bridge(
    ...
    *,
    ...
    """Bind a browser paste handler that appends clipboard images to a file input."""
    import streamlit as st
    ...
    st.html(
        ...
        (() => {{
            ...
            if (!root || window.__apmatiaClipboardPasteBridgeBound === true) return;
            window.__apmatiaClipboardPasteBridgeBound = true;
