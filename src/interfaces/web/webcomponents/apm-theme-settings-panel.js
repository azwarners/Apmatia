class ApmThemeSettingsPanel extends HTMLElement {
  constructor() {
    super();
...
if (!customElements.get("apm-theme-settings-panel")) {
  customElements.define("apm-theme-settings-panel", ApmThemeSettingsPanel);
}
