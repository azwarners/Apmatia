...
from src.core.registry import ToolContribution
    ...
    return [
        {
            ...
            "read_only": True,
            "metadata": {"builtin": True, "library": "apmatia_ipe"},
        },
    ]
...
TOOL_DESCRIPTORS = [
    ToolContribution(
        ...
        action_id="apmatia_ipe.what_do_i_do.action",
        tool_id="apmatia_ipe.what_do_i_do",
        name="whatDoIDo",
