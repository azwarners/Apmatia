...
import src.core.wiki_management_runtime as wiki_runtime
from src.core.module_view_runtime import ModuleViewContext
from src.core.registry import Registry
from src.modules.apmatia_worksim.actions import ACTION_DESCRIPTORS
from src.modules.apmatia_worksim.commands import COMMAND_DESCRIPTORS
from src.modules.apmatia_worksim.module import APMATIA_WORKSIM_MODULE, register
from src.modules.apmatia_worksim.module_views import ApmatiaWorksimModuleViewProvider
from src.modules.apmatia_worksim.views import VIEW_DESCRIPTORS
...
def test_worksim_org_chart_provider_creates_and_updates_tree(tmp_path: Path):
    ...
    try:
        ...
        with patch("src.modules.apmatia_worksim.module_views.get_wiki_manager", return_value=manager):
