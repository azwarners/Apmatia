...
from apmatia.modules.apmatia_worksim.actions import ACTION_DESCRIPTORS
from apmatia.modules.apmatia_worksim.commands import COMMAND_DESCRIPTORS
from apmatia.modules.apmatia_worksim.collections import ORG_CHART_VIEW_SPECS
from apmatia.modules.apmatia_worksim.module import APMATIA_WORKSIM_MODULE, register
from apmatia.modules.apmatia_worksim.module_views import ApmatiaWorksimModuleViewProvider
from apmatia.modules.apmatia_worksim.views import VIEW_DESCRIPTORS


def test_apmatia_worksim_module_registers_module_metadata_and_views():
    registry = Registry()
...
def test_worksim_org_chart_provider_creates_and_updates_tree(tmp_path: Path):
    ...
    try:
        ...
        with patch("apmatia.modules.apmatia_worksim.module_views.get_wiki_manager", return_value=manager):
