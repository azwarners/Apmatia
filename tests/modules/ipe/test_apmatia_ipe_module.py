...
from apmatia.modules.ipe.models import (
    ApmatiaIpeObject,
    CalendarEvent,
    CapturedIdea,
    Habit,
...
from apmatia.modules.ipe.module import APMATIA_IPE_MODULE, register
from apmatia.modules.ipe.actions import ACTION_DESCRIPTORS
from apmatia.modules.ipe.collections import IPE_COLLECTION_VIEW_SPECS
from apmatia.modules.ipe.commands import COMMAND_DESCRIPTORS
from apmatia.modules.ipe.tools import TOOL_DESCRIPTORS
from apmatia.modules.ipe.views import VIEW_DESCRIPTORS


def test_ipe_module_registers_module_metadata():
    registry = Registry()
...
def test_ipe_data_classes_capture_productivity_state():
...
def test_ipe_view_descriptors_define_collection_actions_without_streamlit():
    assert [spec.object_type for spec in IPE_COLLECTION_VIEW_SPECS] == [
        "idea",
        "task",
        "project",
        "habit",
