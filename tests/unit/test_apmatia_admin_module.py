...
def test_apmatia_admin_module_registers_development_metadata_and_tools():
    registry = Registry()
...
def test_admin_tool_definition_includes_prompt_fields():
    definitions = apmatia_admin_tool_definitions()
...
def test_runtime_only_seeds_apmatia_admin_when_development_modules_are_enabled(
    ...
    assert "apmatia_create_agent" not in stable_names
    ...
    assert "apmatia_create_agent" in development_names


def test_stable_mode_disables_persisted_apmatia_admin_tools(tmp_path):
    from apmatia.core.tool_management_runtime import _set_apmatia_admin_tool_definitions_enabled
    ...
    _set_apmatia_admin_tool_definitions_enabled(bundle.tools, development_enabled=False)
    persisted = bundle.tools.get_by_provider_id("builtin.apmatia_create_agent")
