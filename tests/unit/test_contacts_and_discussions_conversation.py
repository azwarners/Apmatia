...
def test_direct_prompt_does_not_inject_role_labels(tmp_path):
    ...
    with patch("apmatia.modules.contacts_and_discussions.services.execute", side_effect=execute), patch(
        "apmatia.modules.contacts_and_discussions.services.OpenAICompatibleBackend"
    ):
