...
@patch("apmatia.modules.discuss.services.KoboldCppBackend")
@patch("apmatia.modules.discuss.services.TextFileStorage")
@patch("apmatia.modules.discuss.services.execute")
