...
class TestBuildChatMessages:
    ...
    def test_includes_image_attachments_for_the_current_prompt(self):
        existing_content = ""
        system_prompt = ""
        current_prompt = "Please inspect this screenshot."
        ...
        result = discussion_templates.build_chat_messages(
            ...
            attachment_resolver=lambda attachment: [
                {
                    "type": "image_url",
                    "image_url": {
                        "url": f"data:{attachment['mime_type']};base64,Zm9v",
                    },
                }
            ],
        )
        ...
        assert result[0]["content"][0] == {"type": "text", "text": "Please inspect this screenshot."}
